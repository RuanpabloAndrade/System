 ...
 * @author ruan
 */
public class Atualizaritempdv extends javax.swing.JFrame {

    /** Creates new form Atualizaritempdv */
    public Atualizaritempdv() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Atualizaritempdv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Atualizaritempdv().setVisible(true);
            }
        });
    }
