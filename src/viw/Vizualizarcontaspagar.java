 ...
 * @author ruan
 */
public class Vizualizarcontaspagar extends javax.swing.JFrame {

    /**
     * Creates new form Vizualizarcontaspagar
     */
    public Vizualizarcontaspagar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Forncedor", "Data de Emissão", "Vencimento", "Valor" }));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jFormattedTextField1, javax.swing.GroupLayout.DEFAULT_SIZE, 502, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        tabelacontaspagar.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fornecedor/empresa", "N.Documento/Pix", " Emissão", "Vencimento", "Valor da conta", "Parcela"
            }
        ));
        tabelacontaspagar.setFocusable(false);
        tabelacontaspagar.setRowHeight(25);
        tabelacontaspagar.setRowSelectionAllowed(false);
        ...
        tabelacontaspagar.setUpdateSelectionOnSort(false);
    ...
    private void  Designtabelapagar(){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      Modulodequitação quitaçao = new Modulodequitação();
      quitaçao.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vizualizarcontaspagar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vizualizarcontaspagar().setVisible(true);
            }
        });
    }
