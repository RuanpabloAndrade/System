...
public class Modelfornecedor {
    ...
    /**
     * @return the incrocaoestadual
     */
    public String getIncrocaoestadual() {
        return incrocaoestadual;
    }

    /**
     * @param incrocaoestadual the incrocaoestadual to set
     */
    public void setIncrocaoestadual(String incrocaoestadual) {
        this.incrocaoestadual = incrocaoestadual;
    }
    ...
    /**
     * @param pixchave the pixchave to set
     */
